      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Link href="/consumer/products" className="group">
            <div className="bg-white dark:bg-gray-800 hover:border-foreground/50 dark:hover:border-foreground/50 border border-gray-200 dark:border-gray-700 p-6 rounded-xl transition-all duration-200 h-full flex flex-col justify-between shadow-sm hover:shadow-md cursor-pointer">
              <div>
