...
export default function ConsumerDashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      >
        {/* Total Orders Card */}
        <motion.div variants={slideUp} className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200 group">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-gray-500 dark:text-gray-400 font-medium text-sm">Total Orders</h3>
            <div className="p-2 bg-foreground/5 dark:bg-foreground/15 text-foreground dark:text-foreground/60 rounded-lg group-hover:bg-foreground/10 dark:group-hover:bg-blue-900/50 transition-colors">
              <Package size={20} />
            </div>
          </div>
        ...
        {/* Impact Card */}
        <motion.div variants={slideUp} className="bg-gradient-to-br border border-gray-100 dark:border-gray-700 from-foreground to-foreground/80 p-6 rounded-xl shadow-md text-background">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Link href="/consumer/products" className="group">
            <motion.div variants={slideUp} className="bg-white dark:bg-gray-800 hover:border-foreground/50 dark:hover:border-foreground/50 border border-gray-200 dark:border-gray-700 p-6 rounded-xl transition-all duration-200 h-full flex flex-col justify-between shadow-sm hover:shadow-md cursor-pointer">
              <div>
                <div className="w-10 h-10 bg-foreground/10 dark:bg-foreground/20 text-foreground dark:text-foreground/60 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                  <Package size={20} />
                </div>
              ...
              <div className="mt-4 flex items-center text-foreground dark:text-foreground/60 text-sm font-medium">
      ...
      {/* INFO CARD */}
      <div className="bg-foreground/5 dark:bg-foreground/10 border border-foreground/10 dark:border-foreground rounded-xl p-6 flex flex-col md:flex-row gap-4 items-start">
        <div className="p-2 bg-foreground/10 dark:bg-blue-800 text-foreground dark:text-foreground/50 rounded-full shrink-0">
          <Info size={24} />
        </div>
        <div>
          <h3 className="font-semibold text-foreground dark:text-background/90 text-lg">How it works</h3>
          <p className="text-foreground/80 dark:text-foreground/40/80 mt-1 max-w-3xl leading-relaxed">
